...
import com.ingbyr.hwsc.planner.planner.AbstractPlanner;
...
@Slf4j
public class Yashp2Planner extends AbstractPlanner implements Planner {
    ...
    public Yashp2Planner(Map<String, Service> serviceMap, Map<String, Concept> conceptMap, int w) {
    ...
    @Override
    public Planner copy() {
        return new Yashp2Planner(serviceMap, conceptMap, w);
    }
