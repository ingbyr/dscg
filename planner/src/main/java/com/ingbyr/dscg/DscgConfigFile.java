 ...
 */
@Slf4j
public final class DscgConfigFile extends DscgConfig {
    ...
    public static final String PLAN_MAX_STEP = "plan_max_step";
     ...
     */
    public DscgConfigFile() throws ConfigurationException {
        ...
        planMaxStep = config.getInt(PLAN_MAX_STEP);
