...
@Slf4j
public class Yashp2 extends AbstractPlanner implements Planner {

    private static final int w = 1;

    private int bMax = Integer.MAX_VALUE;
    ...
    public Planner copy() {
        ...
        planner.setServiceMap(this.serviceMap);
        planner.setConceptMap(this.conceptMap);
        return planner;
    }
        ...
        while (loop) {
            ...
            for (Map.Entry<String, Service> entry : serviceMap.entrySet()) {
                ...
                if (update.get(service)) {
                    ...
                    int c = (int) service.getCost();
                    // int c = sumCost(service.getInputConceptSet(), cost) + (int) (0.5 * service.getCost());
