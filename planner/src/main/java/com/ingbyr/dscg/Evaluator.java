...
@Setter
@Slf4j
public class Evaluator implements Evaluate {
    ...
    private boolean evaluate(Individual individual, Planner planner) {
        ...
        for (reachedStateIndex = 0; reachedStateIndex < individual.getStateSize(); reachedStateIndex++) {
            ...
            Solution solution = planner.solve(middleInputSet, middleGoalSet, plannerMaxStep);
        ...
        solution.searchCost = solution.searchCost
                ...
                + b / (double) (maxStateSize * plannerMaxStep);
